  ...
  return (
    <div className="contact">
        <div className="text">
            ...
            <h3>Please provide your details in the form on the left, and I will respond to your inquiry without delay.<br/> You may also reach out to me on the platforms mentioned on the right-hand side.</h3>
        </div>
        <div className="body">
          ...
          transition={{
            ...
            x: { duration: 0.8, type: "spring", delay: 0.25 },
               ...
               <form className="form">
                ...
                <div className="down">
                    <textarea name="para" placeholder='Your Meassage to me' id="" cols="30" rows="10"></textarea>
                </div>
               </form>
            ...
            <motion.div className="right" initial={{ x: 250, opacity: 0 }}
          whileInView={{ x: 0, opacity: 1 }}
          viewport={{ once: true }}
          transition={{
            opacity: { duration: 0.3, delay: 0.3 },
